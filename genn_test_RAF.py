...
axes[1].set_title("Input layes")
axes[2].vlines(up_spike_times, ymin=0, ymax=1, label='Up')
axes[2].vlines(down_spike_times, ymin=1, ymax=2, label='Down')
axes[2].vlines(left_spike_times, ymin=2, ymax=3, label='Left')
axes[2].vlines(right_spike_times, ymin=3, ymax=4, label='Right')
axes[2].set_xlabel("time [ms]")
axes[2].set_title("Directional neurons")
axes[2].legend()
plt.tight_layout()
plt.show()
